 ...
 */
package com.example.android.whileinuselocation.services
...
import com.example.android.whileinuselocation.utils.now
import com.example.android.whileinuselocation.presentation.activities.MainActivity
...
class ForegroundOnlyLocationService : Service() {
        ...
        locationCallback = object : LocationCallback() {
            override fun onLocationResult(locationResult: LocationResult?) {
                ...
                if (locationResult?.lastLocation != null) {
                    ...
                    Log.d(TAG, locationResult.lastLocation.toString())
                } else {
    ...
    private fun onNewLocation(location: Location) {
        ...
        saveLocationInLocal(currentLocation)
    ...
    private fun saveLocationInLocal(currentLocation: Location?) {
        ...
        if (currentLocation != null){
            ...
            LocationDAO(realm).insert(locationBean)
        }
    }
    ...
    private fun generateNotification(): Notification {
        ...
        val titleText = getString(R.string.udpate_location)

        // 1. Crear un canal de notificación para dispositivos O+ y posteriores 26+
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {

            val notificationChannel = NotificationChannel(
                NOTIFICATION_CHANNEL_ID, titleText, NotificationManager.IMPORTANCE_LOW)

            //Agrega NotificationChannel al sistema. Intentar crear un canal
            //de notificación existente con sus valores originales no realiza ninguna operación,
            //por lo que es seguro realizar la secuencia a continuación.
...
private val UPDATE_INTERVAL_IN_MILLISECONDS: Long = TimeUnit.SECONDS.toMillis(20)
