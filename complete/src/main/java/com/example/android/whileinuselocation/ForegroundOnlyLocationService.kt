...
class ForegroundOnlyLocationService : Service() {
    /*
     * Checks whether the bound activity has really gone away (foreground service with notification created)
     * or simply orientation change (no-op).
     */
    ...
    private fun onNewLocation(location: Location) {
        Log.d(TAG, "onNewLocation(): ${location.latitude} - ${location.longitude} - ${GeneralUtils.getTodayWithHours()}")
